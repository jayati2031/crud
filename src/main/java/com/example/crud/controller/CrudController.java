...
public class CrudController {
    ...
    public ResponseEntity<List<Crud>> getAllCruds(@Valid @RequestParam(required = false) String email) {
        try {
    ...
    public ResponseEntity<Crud> getCrudById(@Valid @PathVariable("id") long id) {
